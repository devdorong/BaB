...
import { RiCalendarLine, RiStoreLine } from 'react-icons/ri';
          ...
          <div className="flex space-y-4">
            {matchings.slice(0, 3).map(i => {
              ...
              return (
                <div
                  key={i.id}
                  className="w-full p-6 bg-white rounded-2xl shadow-[0_4px_8px_rgba(0,0,0,0.03)] transition-all hover:shadow-[0_6px_12px_rgba(0,0,0,0.05)]"
                >
                    ...
                    <div className="flex flex-col flex-1 gap-3">
                      ...
                      <div className="flex flex-col text-sm text-gray-600 leading-relaxed">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-gray-800">{i.restaurants?.name}</span>
                        </div>
                        <div className="flex items-center gap-2">
