  ...
  return (
    <div className="w-full font-normal text-lg bg-bg-bg">
      <div className="w-[1280px] mx-auto p-8 flex flex-col gap-8 ">
        ...
        <div>
          <div>
            <p className="font-bold text-2xl">제1조 (목적)</p>
            <p>
          ...
          <div>
            <p className="font-bold text-2xl">제2조 (정의)</p>
          ...
          <div>
            <p className="font-bold text-2xl">제3조 (약관의 효력 및 변경)</p>
            <ol>
          ...
          <div>
            <p className="font-bold text-2xl">제4조 (회원 가입 및 관리)</p>
            <ol>
          ...
          <div>
            <p className="font-bold text-2xl">제5조 (서비스의 제공 및 변경)</p>
            <ol>
          ...
          <div>
            <p className="font-bold text-2xl">제6조 (회원의 의무)</p>
            <ol>
          ...
          <div>
            <p className="font-bold text-2xl">제7조 (서비스 이용 제한 및 해지)</p>
            <ol>
              <li>
          ...
          <div>
            <p className="font-bold text-2xl">제8조 (면책조항)</p>
            <ol>
              <li>
          ...
          <div>
            <p className="font-bold text-2xl">제9조 (관할 법원 및 준거법)</p>
            <p>
